...
| 10 | [grey parrots](10_parrot/) | two parrots with a physical syrinx and a cochlea each; one net per bird is its memory of what it hears often and the mirror that turns a memory into muscle commands; receipt: recall of a sound 0.625 after a day that repeated it, 0.206 after one that did not (untrained -0.026); its imitations correlate 0.452 with the originals (untrained 0.030); the melody of its imitations tracks the original at 0.125 (untrained -0.165); 162 spontaneous bouts a day; [play it](https://claude.ai/code/artifact/173c5de8-8250-48a0-8f5c-03bd6c9f1e07) |
<!-- /ladder -->
