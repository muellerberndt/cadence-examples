...
| 10 | [grey parrots](10_parrot/) | two parrots with a physical syrinx and a cochlea each; one net per bird is its memory of what it hears often and the mirror that turns a memory into muscle commands; receipt: recall of a sound 0.594 after a day that repeated it, 0.178 after one that did not (untrained -0.005); its imitations correlate 0.455 with the originals (untrained 0.009); 161 spontaneous bouts a day; [play it](https://claude.ai/code/artifact/173c5de8-8250-48a0-8f5c-03bd6c9f1e07) |
<!-- /ladder -->
