...
| 05 | [text](05_text/) | next-character prediction on shakespeare from a sixteen-character window: 1,040 input owners, 65 output owners, and a sample the net wrote; receipt: 3.33 bits/char, next-character accuracy 37.2%; bigram 3.71, one-layer transformer 3.08 |
...
| 10 | [grey parrots](10_parrot/) | two parrots with a physical syrinx and a cochlea each; one net per bird is its memory of what it hears often and the mirror that turns a memory into muscle commands; receipt: recall of a sound 0.604 after a day that repeated it, 0.185 after one that did not (untrained -0.005); its imitations correlate 0.393 with the originals (untrained 0.009); the melody of its imitations tracks the original at 0.002 (untrained 0.121); 162 spontaneous bouts a day; [play it](https://claude.ai/code/artifact/173c5de8-8250-48a0-8f5c-03bd6c9f1e07) |
<!-- /ladder -->
