...
| 10 | [grey parrot](10_parrot/) | a parrot with a physical syrinx and a cochlea; one net is its memory of what it hears often and the mirror that turns a memory into muscle commands; receipt: recall of a sound 0.658 after a day that repeated it, 0.330 after one that did not (untrained 0.001); its imitations correlate 0.527 with the originals (untrained 0.306); 101 spontaneous bouts a day; [play it](https://claude.ai/code/artifact/173c5de8-8250-48a0-8f5c-03bd6c9f1e07) |
<!-- /ladder -->
