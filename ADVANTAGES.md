...
| [Eye & arm](eye-arm/) | Pixel readback, joint coordination and opposing motor populations form a continuous correction loop. Pencil motors control contact. | All targets covered on three fixtures with intact or disturbed feedback; 28–33% after the same disturbance without pose feedback. Silenced joints cannot move; silenced raised-pencil motors cannot draw. These are causal controls, not a trained neural baseline or artistic-fidelity test. |
...
latency. Two orders of magnitude means 100× on the named metric. The recorded memory result is about 50× against one specified update
...
|---|---:|---:|---:|
| Cadence residual memory | 996/996 (100%) | 0.447 ms | 1.0× |
| MLP, 1 update per observation | 565/996 (56.7%) | 1.372 ms | 3.1× |
| MLP, 10 updates | 963/996 (96.7%) | 3.192 ms | 7.1× |
| MLP, 100 updates | 939/996 (94.3%) | 22.463 ms | 50.3× |
